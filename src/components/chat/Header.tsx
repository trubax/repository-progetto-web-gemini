...
import { AnonymousTimer } from './AnonymousTimer';
    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-40 theme-bg-primary shadow-md">
        <div className="p-4 flex justify-between items-center relative">
          ...
          {isAnonymous && (
            <div className="absolute left-1/2 transform -translate-x-1/2 text-sm theme-text whitespace-nowrap max-w-[200px] overflow-hidden text-ellipsis">
              {currentUser?.displayName}
            </div>
          )}

          <div className="flex items-center space-x-2 z-10">
            {isAnonymous && <AnonymousTimer />}
            <img
