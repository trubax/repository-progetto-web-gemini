...
import { Bell, ChevronDown, ChevronRight, Volume2, Vibrate, Radio, Eye, ChevronUp } from 'lucide-react';
    ...
    <div>
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h3 className="theme-text">Notifiche</h3>
            <p className="text-sm theme-text opacity-70">
              Gestisci le notifiche dell'app
            </p>
          </div>
        </div>
      ...
      {expanded && (
        <div className="settings-expand-animation">
          <div className="settings-content p-4 space-y-4 theme-bg-secondary border-t theme-divide">
